...
val initialShopping: ArrayList<ShoppingDestination> = arrayListOf(
   ...
   */
  ShoppingDestination(i18n(S.NFTs), i18n(S.ExplainNFTs), i18n(S.NftUrl), "" ), // R.drawable.ic_niftyart_logo_plain),
  ShoppingDestination(i18n(S.CexButton), i18n(S.ExplainBitmart), "https://www.bitmart.com/trade/en-US?symbol=NEXA_USDT", ""),
  ShoppingDestination(i18n(S.CexButton), i18n(S.ExplainMexc), "https://www.mexc.com/exchange/NEXA_USDT", ""),
